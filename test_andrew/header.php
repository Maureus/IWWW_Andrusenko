    ...
    <div>
        <nav class="nav-header-main">
            <div style="display: flex; padding-left: 1rem;">
                ...
                <a class="mr-2 text-white" href="shop.php">Shop</a>
                <?php
                if (isset($_SESSION["userId"])) {
                    echo '<a class="mr-2 text-white" href="dashboard.php">Dashboard</a>
                            <a class="mr-2 text-white" href="cart.php">My cart</a>
                            <a class="mr-2 text-white" href="orders.php">My orders</a>';
                }
                ?>
            </div>
            <div class="header-login" style="display: flex;">
                <?php
                if (isset($_SESSION["userId"])) {
                    echo '<div class="text-white mr-2">login: ' . $_SESSION["userUid"] . '</div>
                <div class="text-white mr-2">email: ' . $_SESSION["userEmail"] . '</div>
